...
class Config:
    ...
    RESPONSE_MODEL = 'gemini'  # Add 'gemini' as an option
    ...
    GEMINI_MODEL = "gemini-1.5-flash"  # or any other Gemini model you prefer
    ...
    def validate_config():
        ...
        Config._validate_model('RESPONSE_MODEL', [
            'openai', 'groq', 'ollama', 'cerebras', 'gemini', 'local'])
        ...
        Config._validate_api_key('TRANSCRIPTION_MODEL', 'fastwhisperapi', 'FASTWHISPER_API_KEY')

        Config._validate_api_key('RESPONSE_MODEL', 'openai', 'OPENAI_API_KEY')
        Config._validate_api_key('RESPONSE_MODEL', 'groq', 'GROQ_API_KEY')
        Config._validate_api_key('RESPONSE_MODEL', 'cerebras', 'CEREBRAS_API_KEY')
